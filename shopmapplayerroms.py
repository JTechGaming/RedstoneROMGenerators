...
data = [
    [2, 15, 14, 5],
    [2, 21, 18, 14, 5, 4, 0, 3, 18, 21, 3, 9, 6, 9, 24],
    [4, 5, 1, 4, 0, 2, 15, 4, 25],
    [4, 9, 18, 20, 25, 0, 23, 1, 20, 5, 18],
    [4, 9, 19, 20, 21, 18, 2, 5, 4, 0, 19, 1, 12, 20],
    [6, 9, 14, 7, 5, 18, 16, 18, 9, 14, 20],
    [6, 15, 15, 20, 16, 18, 9, 14, 20],
    [7, 8, 15, 19, 20],
    [7, 8, 15, 19, 20, 0, 23, 18, 9, 20, 9, 14, 7],
    [9, 14, 20, 5, 18, 1, 3, 20, 9, 15, 14],
    [8, 1, 21, 14, 20, 5, 4, 0, 13, 9, 18, 18, 15, 18],
    [13, 15, 14, 11, 5, 25, 0, 16, 1, 23],
    [13, 21, 19, 9, 3, 0, 2, 15, 24],
    [15, 21, 9, 10, 1, 0, 2, 15, 1, 18, 4],
    [19, 21, 13, 13, 15, 14, 9, 14, 7, 0, 3, 9, 18, 3, 12, 5],
    [20, 1, 18, 15, 20, 0, 3, 1, 18, 4, 19],
    [22, 15, 15, 4, 15, 15, 0, 4, 15, 12, 12],
]
...
schem.save("out", "namesschematic", mcschematic.Version.JE_1_20_1)