...
# [ # Front
#     23, 1, 6, 30, 27,   0, 0, 0, 0, 0, 0,   18
# ],
# [ # Left
#     98, 0, 0, 0, 0,   77, 85, 89, 101, 94, 96,   70, 25
# ],
# [ # Right
#     55, 0, 0, 0, 59,   63, 34, 37, 42, 48, 51,   40
# ]
#
# Order of execution:
# front, left, right
# so, for example, 23, 98, 55 is the first sequence
# then 1, 0, 59 , then 6, 0, 63, and so on
